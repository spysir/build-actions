...
git clone https://github.com/MasterOfStar/luci-app-pushbot package/luci-app-pushbot-new
git clone https://github.com/spysir/luci-app-autotimeset.git package/luci-app-autotimeset-new
